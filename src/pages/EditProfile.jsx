                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                placeholder="50000"
                                                className="w-full pl-7 pr-4 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition duration-200"
                                            />
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div className="flex gap-3 mt-4">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={saving}
                            className="flex-1 bg-blue-700 dark:bg-blue-600 text-white py-2.5 rounded-lg font-medium hover:bg-blue-800 dark:hover:bg-blue-700 transition duration-200 disabled:opacity-50"
                        >
                            {saving ? (
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-700 pt-6 mt-6">
                        ...
                        <button
                            ...
                            className="w-full border border-blue-700 text-blue-700 dark:text-blue-200 dark:border-blue-400 py-2.5 rounded-lg font-medium hover:bg-blue-50 dark:hover:bg-blue-900/40 transition duration-200"
                        >
                            Change Password
                        </button>
                    </div>
                    ...
                    {/* Danger Zone */}
                    <div className="border-t border-red-100 dark:border-red-800 pt-6 mt-6">
                        ...
                        <button
                            ...
                            className="w-full border border-red-300 dark:border-red-700 text-red-500 dark:text-red-300 py-2.5 rounded-lg font-medium hover:bg-red-50 dark:hover:bg-red-900/40 transition duration-200"
                        >
                            🗑️ Delete My Account
                        </button>
                    </div>
